...
function App() {
  return (
    <Box className='Page'>
      <Box className='Principal secondary-color'>   
        ...
        <Grid width={'1050px'} marginTop={'500px'} marginLeft={'197px'} container spacing={1}>
          ...
          <Grid item xs={6} md={4}>
          <Caja Titulo='Web3 composability' divcolor ='#2DC071' Texto='Launch scholarship/rental features 
  using an interoperable protocol.'></Caja>
          </Grid> 
          <Grid item xs={6} md={4}>
